...
\begin{description}[labelindent=1cm,leftmargin=\onelen,labelwidth=1cm]
    \myitem{\textit{source}}{:} \texttt{subreddit \textit{string} \textbf{\textbar} reddit}
    \myitem{\textit{field}}{:} \texttt{title \textbf{\textbar} upvotes \textbf{\textbar} tags \textbf{\textbar} nsfw}
    \myitem{\textit{nsfw}}{:} \texttt{nsfw \textbf{\textbar} not safe for work}
    \myitem{\textit{sortkey}}{:} \texttt{popular}
\end{description}
