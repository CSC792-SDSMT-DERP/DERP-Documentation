...
\begin{description}[labelindent=1cm,leftmargin=\onelen,labelwidth=1cm]
  ...
  \textbf{\textbar} \ecode{with\_exp string substring\_check field}
  \textbf{\textbar} \ecode{boolean\_check field}
  \textbf{\textbar} \ecode{string\_check field string}
  \textbf{\textbar} \ecode{number\_check number field}
  \textbf{\textbar} \ecode{on\_exp string}
  \textbf{\textbar} \ecode{matching string}
\end{description}
