...
\input{getting\_started.tex}
\input{basic\_usage.tex}
...
\input{syntax\_notation.tex}
\input{language\_extension.tex}
\input{lexical\_conventions.tex}
\input{language\_modes.tex}
\input{data\_types.tex}
\input{statements\_expressions.tex}
